## need to add hrms with standard deviation for /minimization/error
## need to time the sqrt of N for filtering algorithm #surface = np.fft.ifft2(filtered_noise).real*np.sqrt(n*m)
...
#################################################
#####Compute Hertzian contact theory #############
#################################################
